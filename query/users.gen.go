...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Account = userHasOneAccount{
		...
		RelationField: field.NewRelation("Account", "models.Account"),
	}

	_user.Pets = userHasManyPets{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Pets", "models.Pet"),
		Toy: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Pets.Toy", "models.Toy"),
		},
	}
	...
	_user.Toys = userHasManyToys{
		...
		RelationField: field.NewRelation("Toys", "models.Toy"),
	}

	_user.Team = userHasManyTeam{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Team", "models.User"),
		Company: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Team.Company", "models.Company"),
		},
		Manager: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Team.Manager", "models.User"),
		},
		Account: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Team.Account", "models.Account"),
		},
		Pets: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Team.Pets", "models.Pet"),
		},
		Toys: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Team.Toys", "models.Toy"),
		},
		Team: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Team.Team", "models.User"),
		},
		Languages: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Team.Languages", "models.Language"),
		},
		Friends: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Team.Friends", "models.User"),
		},
	}
	...
	_user.Friends = userManyToManyFriends{
		...
		RelationField: field.NewRelation("Friends", "models.User"),
	}
...
func (a userHasOneAccount) Model(m *models.User) *userHasOneAccountTx {
	return &userHasOneAccountTx{a.db.Model(m).Association(a.Name())}
}

type userHasOneAccountTx struct{ tx *gorm.Association }

func (a userHasOneAccountTx) Find() (result *models.Account, err error) {
	return result, a.tx.Find(&result)
}

func (a userHasOneAccountTx) Append(values ...*models.Account) (err error) {
...
func (a userHasOneAccountTx) Replace(values ...*models.Account) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasOneAccountTx) Delete(values ...*models.Account) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasManyPets) Model(m *models.User) *userHasManyPetsTx {
	return &userHasManyPetsTx{a.db.Model(m).Association(a.Name())}
}

type userHasManyPetsTx struct{ tx *gorm.Association }

func (a userHasManyPetsTx) Find() (result []*models.Pet, err error) {
	return result, a.tx.Find(&result)
}

func (a userHasManyPetsTx) Append(values ...*models.Pet) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasManyPetsTx) Replace(values ...*models.Pet) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasManyPetsTx) Delete(values ...*models.Pet) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasManyToys) Model(m *models.User) *userHasManyToysTx {
	return &userHasManyToysTx{a.db.Model(m).Association(a.Name())}
}

type userHasManyToysTx struct{ tx *gorm.Association }

func (a userHasManyToysTx) Find() (result []*models.Toy, err error) {
	return result, a.tx.Find(&result)
}

func (a userHasManyToysTx) Append(values ...*models.Toy) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasManyToysTx) Replace(values ...*models.Toy) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasManyToysTx) Delete(values ...*models.Toy) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasManyTeam) Model(m *models.User) *userHasManyTeamTx {
	return &userHasManyTeamTx{a.db.Model(m).Association(a.Name())}
}

type userHasManyTeamTx struct{ tx *gorm.Association }

func (a userHasManyTeamTx) Find() (result []*models.User, err error) {
	return result, a.tx.Find(&result)
}

func (a userHasManyTeamTx) Append(values ...*models.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasManyTeamTx) Replace(values ...*models.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasManyTeamTx) Delete(values ...*models.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userBelongsToManager) Model(m *models.User) *userBelongsToManagerTx {
	return &userBelongsToManagerTx{a.db.Model(m).Association(a.Name())}
}

type userBelongsToManagerTx struct{ tx *gorm.Association }

func (a userBelongsToManagerTx) Find() (result *models.User, err error) {
	return result, a.tx.Find(&result)
}

func (a userBelongsToManagerTx) Append(values ...*models.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userBelongsToManagerTx) Replace(values ...*models.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userBelongsToManagerTx) Delete(values ...*models.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userManyToManyFriends) Model(m *models.User) *userManyToManyFriendsTx {
	return &userManyToManyFriendsTx{a.db.Model(m).Association(a.Name())}
}

type userManyToManyFriendsTx struct{ tx *gorm.Association }

func (a userManyToManyFriendsTx) Find() (result []*models.User, err error) {
	return result, a.tx.Find(&result)
}

func (a userManyToManyFriendsTx) Append(values ...*models.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userManyToManyFriendsTx) Replace(values ...*models.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userManyToManyFriendsTx) Delete(values ...*models.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
