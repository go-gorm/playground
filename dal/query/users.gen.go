...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.CompanyID = field.NewInt32(tableName, "company_id")
	_user.ManagerID = field.NewInt32(tableName, "manager_id")
	_user.Active = field.NewInt32(tableName, "active")
...
func (u *user) updateTableName(table string) *user {
	...
	u.CompanyID = field.NewInt32(table, "company_id")
	u.ManagerID = field.NewInt32(table, "manager_id")
