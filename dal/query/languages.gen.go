...
func newLanguage(db *gorm.DB, opts ...gen.DOOption) language {
	...
	_language.Code = field.NewString(tableName, "code")
...
func (l language) Columns(cols ...field.Expr) gen.Columns { return l.languageDo.Columns(cols...) }
...
func (l languageDo) Session(config *gorm.Session) *languageDo {
